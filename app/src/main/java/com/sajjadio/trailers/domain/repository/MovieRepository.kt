...
interface MovieRepository {
    ...
    suspend fun getImagesOfMovieById(movieId: Int?): Flow<NetworkStatus<List<Image>?>>
    suspend fun getImagesOfPersonById(personId: Int?): Flow<NetworkStatus<List<Image>?>>
    suspend fun getMoviesOfPersonById(personId: Int?): Flow<NetworkStatus<List<CommonResult>>>
    ...
    fun getMovieSearch(query: String?): Flow<PagingData<CommonResult>>
    fun getMoviesOfGenreById(genreId: Int): Flow<PagingData<CommonResult>>
    suspend fun getGenresMovie(): Flow<NetworkStatus<List<GenresOfMovie>>>
