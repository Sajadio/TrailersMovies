...
class HomeRepoImpl @Inject constructor(
    ...
    override suspend fun getMoviePopular() =
        safeApiCall(api.getPopularMovie()).flowOn(Dispatchers.IO)

    override suspend fun getMovieTopRated() =
        safeApiCall(api.getTopRatedMovie()).flowOn(Dispatchers.IO)

    override suspend fun getUpComingMovie() =
        safeApiCall(api.getUpComingMovie()).flowOn(Dispatchers.IO)
